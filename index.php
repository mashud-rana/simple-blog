...
/* ===================== Pagination Code Starts ================== */
			...
			$statement = $db->prepare("SELECT * FROM tbl_post ORDER BY post_title DESC");
			$statement->execute();
			...
			$statement = $db->prepare("SELECT * FROM tbl_post ORDER BY post_title DESC LIMIT $start, $limit");
			$statement->execute();
